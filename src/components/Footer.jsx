...
export default function Footer() {
  return (
    <footer className="bg-dark border-t border-gold/25 pt-12 pb-6 px-6" role="contentinfo">
      <div className="max-w-[1300px] mx-auto flex flex-col items-center gap-8 text-center">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="text-left">
            ...
            <div className="text-gold text-[0.6rem] tracking-[2.5px] uppercase">Banquet Lawn</div>
          </div>
        </div>
            ...
            {NAV.map(item => (
              <li key={item}>
                <a
                  ...
                  className="text-white/50 text-[0.78rem] tracking-[1.2px] uppercase hover:text-gold-light transition-colors"
                >
                  {item}
                </a>
              </li>
        ...
        <div className="text-white/30 text-xs flex flex-wrap justify-center items-center gap-x-3 gap-y-1 leading-relaxed">
